...
export default function Home() {
  ...
  // função modificadora
  // const [ligth, setLigth] = React.useState(false);
  ...
  return (
    ...
    <div className=' dark:bg-slate-900 bg-slate-200 h-screen '>
      <button onClick={toggleTheme} className='m-8 px-4 py-1 bg-[blue]'>Switch</button>
          <div className="bg-white dark:bg-slate-800 rounded-lg px-6 py-8 ring-1 ring-slate-900/5 shadow-xl w-96 ml-8">
              <div>
